                    ...
                    <div className="mb-3">
                        ...
                        <div className="row mb-4">
                            ...
                            <div className="view zoom overlay z-depth-1 rounded mb-3 mb-md-0">
                                ...
                                src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Vertical/12a.jpg" width="100px" alt="Sample"/> */}
                                <a href="#!">
                                {/* <div className="mask">
                                    <img className="img-fluid"
                        ...
                        <div className="row mb-4 mt-5">
                            ...
                            <div className="view zoom overlay z-depth-1 rounded mb-3 mb-md-0">
                                <img className="img-fluid "
                                src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Vertical/13a.jpg" width="50px" alt="Sample"/>
                                <a href="#!">
                                <div className="mask">
                                    <img className="img-fluid"
                                    src="https://mdbootstrap.com/img/Photos/Horizontal/E-commerce/Vertical/13.jpg" width="100px"/>
                                    <div className="mask rgba-black-slight"></div>
                                </div>
                                </a>
                            </div>
