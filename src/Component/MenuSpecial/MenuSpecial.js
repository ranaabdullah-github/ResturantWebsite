                            ...
                            <div class="tab-menu">
                                ...
                                <div class="slider slider-single">
                                    <div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                            <div class="offer-item">
                                                <img src="images//MenuSpecial/menu-item-thumbnail-01.jpg" alt="" class="img-responsive"/>
                                                <div>
                                                    <h3>GARLIC BREAD</h3>
                                                    <p>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                            <div class="offer-item">
                                                <img src="images//MenuSpecial/menu-item-thumbnail-02.jpg" alt="" class="img-responsive"/>
                                                <div>
                                                    <h3>MIXED SALAD</h3>
                                                    <p>
                                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                            <div class="offer-item">
                                                <img src="images//MenuSpecial/menu-item-thumbnail-03.jpg" alt="" class="img-responsive"/>
                                                <div>
                                    ...
                                    <div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                            <div class="offer-item">
                                                <img src="images//MenuSpecial/menu-item-thumbnail-04.jpg" alt="" class="img-responsive"/>
                                                <div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                            <div class="offer-item">
                                                <img src="images//MenuSpecial/menu-item-thumbnail-05.jpg" alt="" class="img-responsive"/>
                                                <div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                            <div class="offer-item">
                                                <img src="images//MenuSpecial/menu-item-thumbnail-06.jpg" alt="" class="img-responsive"/>
                                                <div>
                                    ...
                                    <div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                            <div class="offer-item">
                                                {/* <img src="images//MenuSpecial/menu-item-thumbnail-07.jpg" alt="" class="img-responsive"> */}
                                                <div>
